...
public class TestListeners extends BaseClass implements ITestListener {
	...
	public void onTestStart(ITestResult result) {
		ExtentTest test = extent
				.createTest(result.getMethod().getTestClass().getName() + " :: " + result.getMethod().getMethodName());
		extentTest.set(test);
	...
	public void onTestFailure(ITestResult result) {
		...
		/*
		 * //String str= result.getTestClass().getRealClass().getSimpleName(); String
		 * str = result.getMethod().getTestClass().getName();
		 * 
